...
def sales_person(sales_person: pd.DataFrame, company: pd.DataFrame, orders: pd.DataFrame) -> pd.DataFrame:
    ...
    orders_company = pd.merge(orders, company[company["name"] == "RED"], on = "com_id", how = "inner")[["sales_id"]]
    
    return sales_person[~sales_person["sales_id"].isin(orders_company["sales_id"])][["name"]]
