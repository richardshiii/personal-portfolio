...
def department_highest_salary(employee: pd.DataFrame, department: pd.DataFrame) -> pd.DataFrame:
    ...
    # find top salary by department
    # group by department name & apply function on salary column
    top = merged[merged["salary"] == merged.groupby("name_y")["salary"].transform(max)]

    new_top = top[["name_y", "name_x", "salary"]].rename(columns = {"name_y":"Department", "name_x":"Employee", "salary":"Salary"})
